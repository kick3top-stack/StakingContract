...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface StakingERC1967ProxyInterface extends Interface {
  ...
  export interface StakingERC1967Proxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): StakingERC1967Proxy;
    waitForDeployment(): Promise<this>;

    interface: StakingERC1967ProxyInterface;
